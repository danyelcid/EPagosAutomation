...
it('Cargar las habilitaciones al convenio', () => {
    ...
    cy.fixture('datosConvenio').then((data) => {
        ...
        //buscar el comercio
        cy.safeType('input[name="tabla:table:iterHead:0:headerColumn:filtro"]', data.comercio, { delay: 15 })
        ...
        cy.safeType('input[name="panelPrincipal:convenios:table:iterHead:0:headerColumn:filtro"]', data.convenio, { delay: 15 })
